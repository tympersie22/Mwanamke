...
resource "aws_kms_key" "terraform_state" {
  description             = "Encrypts MWANAMKE Terraform state"
...
resource "aws_kms_alias" "terraform_state" {
  name          = "alias/mwanamke/terraform-state"
...
check "management_account" {
  assert {
    ...
    error_message = "Bootstrap must run with the AWS Organizations management account."
  }
}
